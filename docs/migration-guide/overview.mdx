...
1.  Data structure changes for all fields with `localized: true`. All nested locale has a new, simplified data structure. You need to create your own migrations that works for your payload collections and fields.
Mmongodb example for a link in a page layout.
